    ...
    return (
      <div className="ks-container" style={{ padding: '4rem 0', maxWidth: '400px', margin: '0 auto' }}>
        <div style={{
          ...
          <h2 style={{ marginBottom: '0.5rem', color: '#2D3748' }}>{t('admin_access')}</h2>
  ...
  return (
    <div className="ks-container" style={{ padding: '2rem 0' }}>
      <div style={{ 
        ...
        <div>
          <span className="ks-eyebrow">{t('admin_panel')}</span>
          <h1 style={{ fontSize: '2.5rem', margin: '10px 0 0', color: '#2D3748' }}>{t('manage_crafts')}</h1>
        </div>
      ...
      {loading ? (
        ...
        <div style={{ 
          ...
          <h3 style={{ color: '#2D3748' }}>{t('no_products')}</h3>
